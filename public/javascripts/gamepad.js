...
var gamepadSupport = {
  ...
  pollGamepads: function() {
    ...
    if (rawGamepads) {
      ...
      // on the screen.
      if (gamepadsChanged) {
      	console.log("Gamepad : " + gamepadSupport.gamepads);
      }
    }
  },
  ...
  updateDisplay: function(gamepadId) {
    ...
    socket.emit('joystick', {'buttons' : gamepad.buttons, 'axes' : gamepad.axes});
    console.log({'buttons' : gamepad.buttons, 'axes' : gamepad.axes});
    /*
